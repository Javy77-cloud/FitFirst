-- sep7bo: retitle deals to First / Last / Lob (spaces around slashes).
...
-- Also adds optional field permissions JSON for the deal field builder.
--> statement-breakpoint
ALTER TABLE "desk_custom_fields" ADD COLUMN IF NOT EXISTS "permissions" jsonb;
--> statement-breakpoint
UPDATE deals AS d
