...
**Batch 4 side branch:** `cursor/admin-company-meetings-0864` — Admin Calendar company / training events (video + group invite). Off batch-3. Do not merge offices UI from the other bot; this slice only seeds office / territory stubs for invite pickers.
