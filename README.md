...
Home tiles drag from the six-dot handle with a following ghost. Resize is 1×1 / 1×2 / 2×1 / 2×2 inside Widget settings only — resizing widget A must not change widget B’s stored w/h. Admin toolbar: Layout (My Production / Pipeline Focus / Retention) and Book (My Book / Agency Book) dropdowns, Widget settings on the right. Social pulse tiles (Facebook, Instagram, X, LinkedIn, GBP) are the same independent tiles. Agents do not get the Book dropdown.
