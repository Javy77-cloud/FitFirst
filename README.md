...
**DIFF WAVE-1 (this branch):** Producer scorecards + Glance (`cursor/producer-scorecards-glance-4f97`, no migration) and E&O audit + Admin Compliance (`cursor/eo-audit-compliance-314d`, `0036_eo_audit_logs`). Ana stays unbound at Cov A **$321,000**. Sidebar `#c5ddf4`. One Pipeline. Alerts off the sidebar.
