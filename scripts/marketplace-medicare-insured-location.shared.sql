-- Source fragment. Do not execute this file by itself.
-- scripts/preview-marketplace-medicare-insured-location.sql
-- scripts/flag-marketplace-medicare-insured-location.sql
-- scripts/backfill-marketplace-medicare-insured-location.sql
-- inline the block below. Those three copies must stay identical.
