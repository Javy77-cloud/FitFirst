...
DIFF K on `cursor/mac-ready-batch4-7pm`. Broker log — not a claims shop. Ana stays unbound, Cov A **$321,000**.

- Additive `0036_claims_fnol`: `claims.contact_id`, loss location, reporter name/phone, `producer_id`, `producer_notified_at`. No reserve or adjuster columns.
