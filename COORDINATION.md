...
## Quotes chrome feel-pass (`cursor/fp-quotes-chrome-ddac`)

Off `cursor/feel-pass-consolidate-sep5b-6195`. Quotes list chrome only. Ana stays unbound / Cov A **$321,000**.

- Each quote card’s top-right **Actions** menu holds Compare, No PDF / Open PDF, email stub, SMS stub, open deal, and appetite log. Those are no longer listed as separate buttons.
...
Third desk profile, separate from Admin and Agent. Lean scaffold only — no BI, voting, or heatmaps.
