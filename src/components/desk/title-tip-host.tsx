...
export function TitleTipHost() {
  ...
  return (
    <div
      ...
      className={
        tip.place === "below"
          ? "ff-title-tip pointer-events-none fixed z-[9999] max-w-xs bg-[#e8eaed] -translate-x-1/2 px-2.5 py-1.5 text-[12px] leading-snug text-navy shadow-md"
          : "ff-title-tip pointer-events-none fixed z-[9999] max-w-xs bg-[#e8eaed] -translate-x-1/2 -translate-y-full px-2.5 py-1.5 text-[12px] leading-snug text-navy shadow-md"
      }
