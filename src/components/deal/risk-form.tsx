  ...
  return (
    <form action={updateRisk} className="ff-card p-4">
      ...
      <Tabs defaultValue="home">
        ...
        <TabsContent value="auto" className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <TabsContent value="life" className="mt-4 text-sm text-muted-foreground">
          Life and health are CRM notes only on the contact. There is no rating for those lines
          in this product.
        </TabsContent>
      </Tabs>
      <div className="mt-4">
