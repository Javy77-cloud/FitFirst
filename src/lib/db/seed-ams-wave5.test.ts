...
describe("AMS wave 5 seed ids", () => {
  it("does not reuse Ana, Elena, Hale, Harbor cert, or earlier AMS ids and keeps Cov A 321000", () => {
    const ids = Object.values(AMS_WAVE5_IDS);
