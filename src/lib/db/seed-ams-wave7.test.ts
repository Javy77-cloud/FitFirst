...
describe("AMS wave 7 seed ids", () => {
  it("does not reuse Ana, Elena, Hale, Harbor, claim, or earlier AMS ids and keeps Cov A 321000", () => {
    const ids = Object.values(AMS_WAVE7_IDS);
