...
export const HOME_FIELDS: QuoteFieldDef[] = [
  ...
  { key: "coverage_b", label: "Coverage B (other structures)", group: "Coverages", input: "select", options: [...COVERAGE_B_OPTIONS], extractKey: "coverage_b", products: [...HO_LL] },
  { key: "coverage_c", label: "Coverage C (contents)", group: "Coverages", input: "select", options: [...COVERAGE_C_OPTIONS], extractKey: "coverage_c" },
  { key: "coverage_d", label: "Coverage D (loss of use)", group: "Coverages", input: "select", options: [...COVERAGE_D_OPTIONS], extractKey: "coverage_d" },
  { key: "coverage_e", label: "Coverage E (liability)", group: "Coverages", input: "select", options: [...COVERAGE_E_OPTIONS], extractKey: "coverage_e" },
  { key: "coverage_f", label: "Coverage F (medical payments)", group: "Coverages", input: "select", options: [...COVERAGE_F_OPTIONS], extractKey: "coverage_f" },
