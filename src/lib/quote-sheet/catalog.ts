...
export const HOME_FIELDS: QuoteFieldDef[] = [
  ...
  { key: "personal_injury", label: "Personal Injury", group: "Coverages", input: "text", extractKey: "personal_injury", products: [...HO_LL] },
  ...
  { key: "theft", label: "Theft", group: "Coverages", input: "text", extractKey: "theft", products: [...HO_LL] },
  { key: "home_computer", label: "Home Computer", group: "Coverages", input: "text", extractKey: "home_computer", products: [...HO_LL] },
  {
  ...
  {
    key: "dwelling_replacement_cost",
    label: "Replacement Cost Dwelling",
    group: "Coverages",
    input: "text",
    extractKey: "dwelling_replacement_cost",
    products: [...HO_LL],
  },
  {
    key: "personal_property_replacement_cost",
    label: "Replacement Cost Contents",
    group: "Coverages",
    input: "text",
    extractKey: "personal_property_replacement_cost",
    products: [...HO_LL],
  },
  {
    key: "extended_replacement_cost_dwelling",
    label: "Extended Replacement Cost - Dwelling",
    group: "Coverages",
    input: "text",
    extractKey: "extended_replacement_cost_dwelling",
    products: [...HO_LL],
  },
