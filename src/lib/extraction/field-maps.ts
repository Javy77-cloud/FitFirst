...
export const WIND_MIT_FIELD_MAP: FieldMapRow[] = [
  { sourceLabel: "Roof covering", sheetField: "roof_covering", aliases: ["Roof cov", "Roof type", "Roof material"] },
  { sourceLabel: "Roof deck attachment", sheetField: "roof_deck", aliases: ["Roof deck"] },
  { sourceLabel: "Roof-to-wall connection", sheetField: "roof_to_wall", aliases: ["Roof to wall connection", "Roof to wall"] },
  { sourceLabel: "Opening protection", sheetField: "opening_protection", aliases: ["Opn prot", "Shutters"] },
  { sourceLabel: "Roof geometry", sheetField: "roof_shape", aliases: ["Roof shape"] },
  { sourceLabel: "Secondary water resistance", sheetField: "swr", aliases: ["SWR", "Secondary water"] },
  { sourceLabel: "Year built", sheetField: "year_built", aliases: ["Yr Blt", "Yr Built", "Year of construction"] },
  { sourceLabel: "Roof year", sheetField: "roof_year", aliases: ["Year of roof", "Roof installed"] },
  ...
  { sourceLabel: "Location", sheetField: "address", aliases: ["Property address", "Insured location"] },
...
export const DEC_PAGE_FIELD_MAP: FieldMapRow[] = [
  { sourceLabel: "Named insured", sheetField: "named_insured", aliases: ["Primary named insured", "Insured"] },
  ...
  { sourceLabel: "Square feet", sheetField: "square_feet", aliases: ["Sq ft", "Living area", "Heated sq ft"] },
  { sourceLabel: "Bedrooms", sheetField: "beds", aliases: ["Beds"] },
  { sourceLabel: "Bathrooms", sheetField: "baths", aliases: ["Baths"] },
  { sourceLabel: "Coverage A", sheetField: "coverage_a", aliases: ["Coverage A Dwelling", "Cov A", "Dwelling", "Dwelling limit", "Building limit"] },
  { sourceLabel: "Coverage B", sheetField: "coverage_b", aliases: ["Coverage B Other Structures", "Cov B", "Other structures"] },
  { sourceLabel: "Coverage C", sheetField: "coverage_c", aliases: ["Coverage C Personal Property", "Cov C", "Personal property", "Contents"] },
  { sourceLabel: "Coverage D", sheetField: "coverage_d", aliases: ["Coverage D Loss of Use", "Cov D", "Loss of use", "Additional living"] },
  ...
  { sourceLabel: "Current premium", sheetField: "current_premium", aliases: ["Annual premium", "Total premium", "Premium"] },
