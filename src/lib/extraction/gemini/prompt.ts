...
4. Coverage limits. The declaration page is the source of truth. Do not invent a limit, deductible, or premium that is not printed. When an issued auto dec is on the page and a coverage row is absent, set that coverage's value to the exact string None (not 0, not blank, not omitted). Every coverage column must be filled: limit, deductible, and premium. If that column is not printed, its value is None. Page 1 of a dec often has the carrier and vehicles and no BI/PD/UM/PIP/comp/collision table — still emit None for each missing coverage once you know the file is an issued auto dec. Read every page of a multi-page PDF. If page 2 or a later page prints the coverage table, fill from that page: Bodily Injury or Liability Bodily Injury → liability_bi as 100/300 (not 100000/300000). If Each Person and Each Accident are separate cells, join them as 100/300. Property Damage → liability_pd digits (100000). Uninsured or Underinsured Motorist, including Uninsured Motorist Bodily Injury → um_uim. Uninsured Motorist Property Damage → um_pd (do not put it in liability_pd). Stacked or Non-stacked, when printed, → um_stacked. PIP or Personal Injury Protection → pip digits for the limit. When the PIP row also prints a deductible, put that in pip_deductible (1000), not only inside the pip string. Comprehensive or Other Than Collision → comp_deductible (the deductible, not ACV). Collision → collision_deductible. Full glass → glass. Medical payments, rental reimbursement, and towing / emergency road service are separate from PIP — include them only when printed (med_pay, rental, towing, ers). When that same coverage row prints a premium, add the sibling: liability_bi_premium, liability_pd_premium, pip_premium, um_uim_premium, um_pd_premium, med_pay_premium, comp_premium, collision_premium, rental_premium, towing_premium, glass_premium. Digits only. Do not use a line premium as current_premium. Per-vehicle physical damage when the table is per car: vehicle_1_comp_deductible, vehicle_1_collision_deductible, vehicle_1_comp_premium, vehicle_1_collision_premium, and the same vehicle_2_* / vehicle_3_* / vehicle_4_* keys, plus vehicle_1_premium … vehicle_4_premium for that car's own premium. Discounts, when listed, → discounts. Driver license state, when printed, → driver_1_license_state … driver_4_license_state.
5. Per-vehicle overview, for every vehicle on the dec: year, make, model, VIN, use, annual miles, garaging address, garaging ZIP, lienholder or loss payee, and that vehicle's own premium. If the vehicle is listed and one of those overview facts is not printed, set that field to None. Also include when printed: term_length (6 month or 12 month — do not calculate it from the dates), each driver's license_state, relationship, and excluded yes/no. List discounts in a discounts array. Named insured may be printed LAST FIRST or LAST, FIRST — copy it as printed. A phone photo may be sideways, upside down, or skewed; read the page as if it were upright.
...
Coverage example — only when some page prints a coverage table. Emit each key only when that cell is printed. Omit a blank deductible or premium. Never copy these sample values. Do not invent a 0. Do not invent coverages:
{"liability_bi":{"value":"100/300","confidence":0.9},"liability_bi_premium":{"value":"412","confidence":0.9},"liability_pd":{"value":"100000","confidence":0.9},"liability_pd_premium":{"value":"188","confidence":0.9},"pip":{"value":"10000","confidence":0.9},"pip_deductible":{"value":"1000","confidence":0.9},"pip_premium":{"value":"220","confidence":0.9},"med_pay":{"value":"5000","confidence":0.9},"med_pay_premium":{"value":"18","confidence":0.9},"um_uim":{"value":"100/300","confidence":0.9},"um_uim_premium":{"value":"64","confidence":0.9},"um_stacked":{"value":"Non-stacked","confidence":0.9},"um_pd":{"value":"100000","confidence":0.9},"um_pd_premium":{"value":"22","confidence":0.9},"comp_deductible":{"value":"500","confidence":0.9},"comp_premium":{"value":"90","confidence":0.9},"collision_deductible":{"value":"500","confidence":0.9},"collision_premium":{"value":"310","confidence":0.9},"rental":{"value":"30/900","confidence":0.9},"rental_premium":{"value":"12","confidence":0.9},"towing":{"value":"100","confidence":0.9},"towing_premium":{"value":"6","confidence":0.9},"glass":{"value":"50","confidence":0.9},"glass_premium":{"value":"4","confidence":0.9},"discounts":{"value":"Multi-car; Paperless","confidence":0.9}}
