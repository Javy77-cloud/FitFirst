...
- Money: premiums are digits only (no $); keep cents. Coverage A, B, C, D, E, and F dollar limits use $130,000 (a printed percent stays 10%). Hurricane, all-other-perils (AOP), and wind/hail deductibles that are dollar amounts use $1,000; a percent stays 2%. Dates: keep as printed. Stories / year_built: integers as strings.
