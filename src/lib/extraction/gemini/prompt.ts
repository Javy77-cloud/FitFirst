...
1. Current Policy. Do not leave these empty when the dec prints them. Copy only what is printed.
   ...
   - current_premium: total term premium when printed, digits only, cents kept (3393.51). Travelers and similar issued policies: Total Premium, Full Term Premium, or the 6-month premium (2109.00 stays 2109.00 — not a shopping quote).
