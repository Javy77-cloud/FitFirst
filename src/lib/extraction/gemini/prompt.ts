...
- Dec: Named insured; Residence premises / Location description / Property information / insured property → property_address
  ...
  construction_type; year_built (Year of Construction); roof_year (Year of Roof/Updated);
  type_of_residence (Owner Occupied); dwelling_type (Single Family); months_occupied (9 to 12 Months); occupancy (Owner).
