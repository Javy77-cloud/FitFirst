...
- Dec: Named insured; Residence premises / Location description / Property information / insured property → property_address
  ...
  construction_type (keep Masonry on construction_type; do not store it as occupancy); year_built and year_of_construction are both the printed Year of Construction (MUST fill year_built with that four-digit year whenever Year of Construction, Year Built, or Yr Built is printed — never leave year_built null); roof_year (Year of Roof/Updated);
