...
1. Current Policy. Do not leave these empty when the dec prints them. Copy only what is printed.
   ...
   - current_premium: the policy term total when printed, digits only, cents kept (3393.51). On a Travelers (or similar) issued auto policy read Total Premium, Full Term Premium, Total Premium for This Policy, or Premium Due when that figure is the term total (2109.00 stays 2109.00). Do not use one coverage-line premium. This is not a shopping quote. A phone photo or HEIC of the declarations page counts — read the same labels.
...
- Liability-only policy (personal liability, manufactured-home liability, no dwelling / Coverage A printed):
  ...
  square_feet, construction, roof, coverage_a, or other dwelling facts. Leave those keys null so
