...
- Dec: Named insured; Residence premises / Location description / Property information / insured property → property_address
  ...
  type_of_residence (Owner Occupied); dwelling_type (Single Family); months_occupied (9 to 12 Months); occupancy (the Occupancy line: Owner or Tenant). When the Occupancy line is missing and Type of Residence is Owner Occupied or Tenant, set occupancy from that residence and still store type_of_residence. When neither Occupancy nor Type of Residence is printed, leave occupancy null. A unit-owners / condo / HO-6 Rating Characteristics block (County, Territory, Year Built, Protection Class, Building Grade, Construction, Roof, Shutters) often has no Occupancy — do not invent Owner from unit-owners, condo, or HO-6. Do not invent a mortgagee.
