export const CLEAN_DEC_TEXT = `HOMEOWNERS DECLARATIONS
Named Insured: Ana Dib
Additional Named Insured: George Dib
Location: 1098 Adige Ct SE, Palm Bay, FL 32909
City: Palm Bay
County: Brevard
Year Built: 1989
Construction: Frame
...
export const MESSY_WIND_MIT_TEXT = `[HANDWRITTEN / LOW OCR] WIND MITIGATION INSPECTION
Poor scan — messy handwriting on roof and openings.

Yr Blt: 1q89?
Roof covering: clay t1le + mtl
Roof year: 1989?
Opn prot: n0ne / unk
Construction: fr4me
Occupancy: owner
