...
describe("moduleTitleFromPath", () => {
  it("matches list and record routes to the nav module", () => {
    ...
    expect(moduleTitleFromPath("/documents/signed")).toBe("Signed documents");
    expect(moduleTitleFromPath("/esign")).toBe("Signed documents");
    ...
    expect(moduleTitleFromPath("/alerts")).toBe("Notifications");
    expect(moduleTitleFromPath("/notifications")).toBe("Notifications");
    expect(moduleTitleFromPath("/tasks")).toBe("Notifications");
