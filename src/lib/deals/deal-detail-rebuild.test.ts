...
describe("deal detail final rebuild", () => {
  ...
  it("stacks deal title, tabs, then LOB with no right-side title chrome", () => {
    ...
    expect(page).toMatch(/data-ff-deal-title/);
    expect(page).toMatch(/data-ff-deal-title-row/);
    expect(page).toMatch(/data-ff-deal-title-meta/);
    expect(page).toMatch(/data-ff-deal-flush-tabs/);
    ...
    expect(page.indexOf("data-ff-deal-title")).toBeLessThan(page.indexOf("data-ff-deal-title-meta"));
    expect(page.indexOf("data-ff-deal-title-meta")).toBeLessThan(page.indexOf("<SheetHealthToggle"));
  ...
  it("pins quick comms and keeps motivation in the corner", () => {
    ...
    expect(page.indexOf("data-ff-deal-title-meta")).toBeLessThan(page.indexOf("<SheetHealthToggle"));
    expect(page.indexOf("<DealMotivation")).toBeLessThan(page.indexOf("<SectionTabs"));
    expect(page.indexOf("<DealMotivation")).toBeLessThan(page.indexOf("data-ff-deal-identity"));
